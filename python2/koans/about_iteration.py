...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # reduce iterates over a collections and applies a function to each iteration.  
        # The function excepts the current item and an accumulator, and returns the accumulator. 
        # Reduce takes an optional 3rd argument with a starting value for the accumulator
    ...
    def test_all_iteration_methods_work_on_any_sequence_not_just_lists(self):
        ...
        self.assertEqual(range(11, 14), list(result))
